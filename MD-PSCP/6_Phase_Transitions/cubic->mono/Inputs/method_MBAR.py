...
for state in range(nstates):
    ...
    dataa = pd.read_csv(f'.../../../1_NPT_equilibration/cubic/Outputs/{int(temp[state])}_output.out', sep=" ")
    ...
    datab = pd.read_csv(f'../../../1_NPT_equilibration/mono/Outputs/{int(temp[state])}_output.out', sep=" ")
